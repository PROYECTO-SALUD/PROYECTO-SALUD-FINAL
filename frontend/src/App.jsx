...
const MedicoPanel = () => <div className='p5'><h1>Panel del Medico</h1><p>Ver Citas e Historias Clinicas.</p></div>;
const PacientePanel = () => <div className='p5'><h1>Panel del Paciente</h1><p>Aqui se agendaran citas medicas.</p></div>;
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* REGLA DE SEGURIDAD: Si alguien escribe una ruta que no existe, lo mandamos al Login */}
